...
class Conv2DOutput():  # pylint:disable=too-few-public-methods
    ...
    def __init__(self,
                 filters: int,
                 kernel_size: T.Union[int, tuple[int]],
...
class Conv2DBlock():  # pylint:disable=too-few-public-methods
    ...
    def __init__(self,
                 filters: int,
                 kernel_size: T.Union[int, tuple[int, int]] = 5,
                 strides: T.Union[int, tuple[int, int]] = 2,
                 padding: str = "same",
...
class SeparableConv2DBlock():  # pylint:disable=too-few-public-methods
    ...
    def __init__(self,
                 filters: int,
                 kernel_size: T.Union[int, tuple[int, int]] = 5,
                 strides: T.Union[int, tuple[int, int]] = 2, **kwargs) -> None:
...
class UpscaleBlock():  # pylint:disable=too-few-public-methods
    ...
    def __init__(self,
                 filters: int,
                 kernel_size: T.Union[int, tuple[int, int]] = 3,
                 padding: str = "same",
                 scale_factor: int = 2,
                 normalization: T.Optional[str] = None,
                 activation: T.Optional[str] = "leakyrelu",
