...
class DetectedFaces():
    ...
    def filter(self) -> Filter:
        """Handles returning of faces and stats based on the current user set navigation mode
        filter."""
        return self._filter

    @property
    def update(self) -> FaceUpdate:
        """Handles the adding, removing and updating of :class:`~lib.align.DetectedFace` stored
    ...
    def tk_edited(self) -> tk.BooleanVar:
        """The variable indicating whether an edit has occurred meaning a GUI redraw needs to be
        triggered."""
    ...
    def tk_face_count_changed(self) -> tk.BooleanVar:
        ...
        :class:`FaceViewer` grid redraw needs to be triggered."""
