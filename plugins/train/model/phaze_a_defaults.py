...
_DEFAULTS = dict(
    ...
    enc_architecture=dict(
        ...
        info="The encoder architecture to use. See the relevant config sections for specific "
             ...
             "\n\tmobilenet: (32px - 224px). Additional MobileNet parameters can be set with the "
             "'mobilenet' options. Ref: MobileNets: Efficient Convolutional Neural Networks for "
    ...
    freeze_layers=dict(
        ...
        datatype=list,
        choices=["encoder", "keras_encoder", "fc_a", "fc_b", "fc_both", "fc_shared", "fc_gblock",
                 "g_block_a", "g_block_b", "g_block_both", "decoder_a", "decoder_b",
                 "decoder_both"],
        group="weights",
        fixed=False),
    load_layers=dict(
