...
class ModelBase():
    ...
    def __init__(self,
        ...
        logger.debug("Initializing ModelBase (%s): (model_dir: '%s', gpus: %s, configfile: %s, "
                     "snapshot_interval: %s, no_logs: %s, wandb_logs: %s, warp_to_landmarks: "
                     ...
                     no_logs, wandb_logs, warp_to_landmarks, augment_color, no_flip,
    ...
    def set_training_data(self):
        ...
        self.training_opts["wandb_logs"] = self.state.current_session["wandb_logs"]
...
class State():
    ...
    def __init__(self, model_dir, model_name, config_changeable_items,
                 no_logs, wandb_logs, pingpong, training_image_size):
