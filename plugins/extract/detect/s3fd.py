...
################################################################################
class ElementwiseLayerO2K(get_keras("layers.Layer")):
...
class SliceO2K(get_keras("layers.Layer")):
...
class ReduceLayerO2K(get_keras("layers.Layer")):
...
class SqrtO2K(get_keras("layers.Layer")):  # pylint:disable=too-few-public-methods
...
class PowO2K(get_keras("layers.Layer")):  # pylint:disable=too-few-public-methods
...
class ConstantLayerO2K(get_keras("layers.Layer")):
