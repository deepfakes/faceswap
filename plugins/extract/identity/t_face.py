...
class TFace(FacePlugin):
    ...
    def load_model(self) -> IRNet:
        ...
        return T.cast("IRNet", self.load_torch_model(model(input_size), weights))
...
any additional terms or conditions. Notwithstanding the above, nothing herein shall supersede or
...
TFace-可信人脸算法框架 is licensed under the Apache License, Version 2.0
"""
