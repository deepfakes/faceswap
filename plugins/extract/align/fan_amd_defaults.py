#!/usr/bin/env python3
"""
    The default options for the faceswap FAN-AMD Detect plugin.
...
_HELPTEXT = (
    "Fan-AMD Aligner options. Uses the keras backend to support AMD cards.\n"
    "Best aligner. GPU heavy, slow when not running on GPU."
    )
...
_DEFAULTS = {
    ...
    "batch-size": {
        ...
        "info": "The batch size to use. Normally higher batch sizes equal better performance.\n"
                "A batchsize of 16 requires about 1.6 GB vram.",
        "datatype": int,
        "rounding": 1,
        "min_max": (1, 32),
        "choices": [],
