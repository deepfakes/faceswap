...
class Convert():
    def __init__(self, encoder, blur_size=2, seamless_clone=False, mask_type="facehullandrect", erosion_kernel_size=None, match_histogram=False, **kwargs):
    ...
    def patch_image( self, image, face_detected ):
        ...
        out_image = self.apply_new_face(image, new_face, image_mask, mat, image_size, size)
