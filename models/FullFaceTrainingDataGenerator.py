...
class FullFaceTrainingDataGenerator(TrainingDataGeneratorBase):
    ...
    def onProcessSample(self, sample, debug):
        ...
        warped, target, debug_image = FullFaceTrainingDataGenerator.warp (s_image, sample.landmarks, d_image, d_landmarks, self.warped_size, self.target_size, debug)
