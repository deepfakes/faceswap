    ...
    def onInitialize(self, batch_size=-1, **in_options):
        ...
        if self.is_training_mode:
            ...
            self.set_training_data_generators ([            
                    TrainingDataGenerator(self, TrainingDataType.SRC,  batch_size=self.batch_size, output_sample_types_flags=[ f.WARPED | f.HALF_FACE | f.MODE_BGR | f.SIZE_128, f.TARGET | f.HALF_FACE | f.MODE_BGR | f.SIZE_128, f.TARGET | f.HALF_FACE | f.MODE_M | f.SIZE_128], random_flip=True ),
                    TrainingDataGenerator(self, TrainingDataType.DST,  batch_size=self.batch_size, output_sample_types_flags=[ f.WARPED | f.HALF_FACE | f.MODE_BGR | f.SIZE_128, f.TARGET | f.HALF_FACE | f.MODE_BGR | f.SIZE_128, f.TARGET | f.HALF_FACE | f.MODE_M | f.SIZE_128] )
                ])
